...
## 현업 프로젝트(최신순)
|제목|회사명|참여<br>인원|한 줄<br>요약|역할|관련 문서|완료일시<br>(기간)|
|---|---|---|---|---|---|---|
|Alpha Streaming|(주)알파서클|Frontend<br>3<br>Backend<br>3|VR Contents Streaming System|파일 시스템 구축&테스트,<br>로그 저장&검색 시스템 구축,<br>모니터링 시스템 구축|- [File](https://subdued-lentil-b20.notion.site/Load-Test-on-EBS-EFS-b2b5c26183064ba0a0818aafda91edc5)<br>- [문서2]()<br>- [문서3]()|2023.09<br> ~ 진행 중 |
