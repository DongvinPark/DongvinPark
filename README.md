...
|---|---|---|---|---|---|---|---|
|EverChat 재개발|(주)에버라인<br>(주)알파서클|FE 2<br>BE 1|Fandom Chatting Service App Migration|팬덤 채팅 서비스 백엔드 전체 재개발(Python -> Java)|[성능테스트](https://subdued-lentil-b20.notion.site/SpringBoot-STOMP-32f3aeddf7f480f68c6bf0ba2402394d)|진행 중|약 2.5억 원<br>(외주용역)|
