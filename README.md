...
|---|---|---|---|---|---|---|
|AlphaView 3.0|(주)알파서클|Frontend<br>3<br>Backend<br>3|VR Contents Streaming System|RTSP 스트리밍 구현|[RTSP]()|2024.08<br> ~ 진행 중 |
|AlphaView 2.0|(주)알파서클|Frontend<br>3<br>Backend<br>3|VR Contents Streaming System|파일 시스템 구축&테스트,<br>pause switching 구현|[File](https://subdued-lentil-b20.notion.site/Load-Test-on-EBS-EFS-b2b5c26183064ba0a0818aafda91edc5)<br>[스위칭](https://github.com/DongvinPark/Debug-Archive/blob/main/Pause-Switching-Impl.md)|2024.08<br>(11 개월) |
