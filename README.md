...
## 경력
- 주식회사 알파서클(2023.05 ~ 현직) : 백엔드 및 VR 플레이어 개발
...
- ![LANGUAGE](https://img.shields.io/badge/Language-gray)
  - main : ![JAVA](https://img.shields.io/badge/JAVA-orange) / toy pjt : ![C++](https://img.shields.io/badge/C++-informational), ![TypeScript](https://img.shields.io/badge/TypeScript-informational)<br><br/>
...
- ![Payments](https://img.shields.io/badge/Payments-gray)
  - ![Toss Payments](https://img.shields.io/badge/Toss_Payments_Billing_API-blue), ![RTDN/ASSN](https://img.shields.io/badge/RTDN_/_ASSN-blue)<br><br/>
...
## 현업 프로젝트(최신순)
|제목|참여<br>인원|한 줄<br>요약|역할|관련<br>문서|완료일시<br>(기간)|
|---|---|---|---|---|---|
|AlphaView 3.0|FE 3<br>BE 3|High Resolution VR Contents Streaming System|RTSP 스트리밍 시스템 구현<br>(Server & Player),<br>bitrate 저감 기술 구현,<br>자막 렌더링 구현|[RTSP](https://github.com/DongvinPark/Debug-Archive/blob/main/AlphaView3-Impl.md)<br><br>[bitrate](https://github.com/DongvinPark/Debug-Archive/blob/main/AlphaView3-bitrate.md)|2025.02<br>(7 개월) |
|AlphaView 2.0|FE 3<br>BE 3|High Resolution VR Contents Streaming System|파일 시스템 구축&테스트,<br>pause switching 구현|[File](https://subdued-lentil-b20.notion.site/Load-Test-on-EBS-EFS-b2b5c26183064ba0a0818aafda91edc5)<br><br>[스위칭](https://github.com/DongvinPark/Debug-Archive/blob/main/Pause-Switching-Impl.md)|2024.08<br>(11 개월) |
|VROADWAY App|BE 2|VROADWAY App API Server Migration|JPA Entity 매핑,<br>CI/CD PipeLine 구축,<br>7계층 DDoS 공격 방어 WAF 구축|[CI/CD](https://github.com/DongvinPark/AWS-Code-Pipe-Line-Test)<br><br>[DDoS](https://subdued-lentil-b20.notion.site/AWS-WAF-7-DDos-209c0527a11a40a08d738c390effe505)|2023.9.30<br>(4 개월)|
...
|---|---|---|---|---|---|
|Macro Economy Board|개인|경제지표 그래프와 이벤트를 함께 렌더링해주는 정적 [웹앱](https://d504z0jut0258.cloudfront.net/)|전체 개발 및 배포,<br>리팩토링|[링크](https://github.com/DongvinPark/MacroEconBoard)|2026.April.<br>(7 개월)|
...
|ArtBubble|FE 2<br>BE 3|인스타그램 클론코딩|게시물 추천 로직 개발,<br>쿼리 성능최적화,<br>리팩토링|[링크](https://github.com/DevTraces/BackEnd)|2023.Mar.<br>(2 개월)|
...
## ![](https://img.shields.io/badge/-사람,_커리어-blue)
...
- [첫 번째 SI 프로젝트에서 '기술'에 대해 배운점 5 가지](https://github.com/DongvinPark/Debug-Archive/blob/main/MyFirstSIandTech.md)

<br>

## ![](https://img.shields.io/badge/-Computer_Science-blue)
- [요청이 몰리면 서버가 죽거나 느려지는 이유 - 소켓 뒤에 숨겨진 것들](https://github.com/DongvinPark/Debug-Archive/blob/main/Why-Server-Dies.md)
