...
|---|---|---|---|---|---|---|---|
|EverChat 재개발|(주)에버라인<br>(주)알파서클|Frontend<br>2<br>Backend<br>1|Fandom Chatting Service App Migration|채팅 서비스 백엔드 전체 재개발(Python -> Java)|[성능테스트](https://subdued-lentil-b20.notion.site/SpringBoot-STOMP-32f3aeddf7f480f68c6bf0ba2402394d)|진행 중|약 5천만 원|
