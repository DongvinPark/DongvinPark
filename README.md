...
## (주)알파서클에 재직 중인 백엔드 및 VR 개발자 박동빈입니다 :)
## dongvin99@naver.com
...
|---|---|---|---|---|---|---|
|AlphaView 3.0|(주)알파서클|Frontend<br>3<br>Backend<br>3|High Resolution VR Contents Streaming System|RTSP 스트리밍 시스템 구현<br>(Server & Player),<br>bitrate 저감 기술 구현|[RTSP](https://github.com/DongvinPark/Debug-Archive/blob/main/AlphaView3-Impl.md)<br>[bitrate]()|2025.02<br>(7 개월) |
