...
- ![](https://img.shields.io/badge/AWS-gray)
  ...
  - ![](https://img.shields.io/badge/Secrets_Manager-red)<br><br/>
...
|---|---|---|---|---|---|---|---|
|EVERCHAT 2.0|(주)에버라인<br>(주)알파서클|FE 2<br>BE 1|Fandom Chatting Service App Migration|팬덤 채팅 서비스 백엔드 전체 재개발 및 배포(Python -> Java)|[아키텍처](https://github.com/DongvinPark/Debug-Archive/blob/main/Everchat2.0.md)<br><br>[성능테스트](https://subdued-lentil-b20.notion.site/SpringBoot-STOMP-32f3aeddf7f480f68c6bf0ba2402394d)|2026.08<br>(4 개월)|약 1.5억 원<br>(외주용역)|
|AlphaView 3.0|(주)알파서클|FE 3<br>BE 3|High Resolution VR Contents Streaming System|RTSP 스트리밍 시스템 구현<br>(Server & Player),<br>bitrate 저감 기술 구현,<br>자막 렌더링 구현|[RTSP](https://github.com/DongvinPark/Debug-Archive/blob/main/AlphaView3-Impl.md)<br><br>[bitrate](https://github.com/DongvinPark/Debug-Archive/blob/main/AlphaView3-bitrate.md)|2025.02<br>(7 개월) |2억 원<br>(정부과제)|
|AlphaView 2.0|(주)알파서클|FE 3<br>BE 3|High Resolution VR Contents Streaming System|파일 시스템 구축&테스트,<br>pause switching 구현|[File](https://subdued-lentil-b20.notion.site/Load-Test-on-EBS-EFS-b2b5c26183064ba0a0818aafda91edc5)<br><br>[스위칭](https://github.com/DongvinPark/Debug-Archive/blob/main/Pause-Switching-Impl.md)|2024.08<br>(11 개월) |-<br>(연구 개발)|
|VROADWAY App|(주)알파서클|BE 2|VROADWAY App API Server Migration|JPA Entity 매핑,<br>CI/CD PipeLine 구축,<br>7계층 DDoS 공격 방어 WAF 구축|[CI/CD](https://github.com/DongvinPark/AWS-Code-Pipe-Line-Test)<br><br>[DDoS](https://subdued-lentil-b20.notion.site/AWS-WAF-7-DDos-209c0527a11a40a08d738c390effe505)|2023.9.30<br>(4 개월)|4천만 원<br>(자사 서비스)|
