...
|---|---|---|---|---|---|---|
|Alpha Streaming|(주)알파서클|Frontend<br>3<br>Backend<br>3|VR Contents Streaming System|파일 시스템 구축&테스트,<br>로그 저장&검색 시스템 구축|- [file system](https://subdued-lentil-b20.notion.site/Load-Test-on-EBS-EFS-b2b5c26183064ba0a0818aafda91edc5)<br>- [문서2]()|2023.09 ~ 진행 중 |
